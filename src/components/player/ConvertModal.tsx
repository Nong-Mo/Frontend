...
const ConvertModal: React.FC<ConvertModalProps> = ({
    ...
    const {type, id} = useParams(); // fileID 파라미터 가져오기
    ...
    const options = [
        {
            label: '오디오 듣기',
            value: 'audio',
            path: `/player/${type}/audio/${id}`,
            icon: music,
        },
        {
            label: 'PDF 보기',
            value: 'pdf',
            path: `/player/${type}/pdf/${id}`,
            icon: document,
        },
    ];
    ...
    return (
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center z-50">
            <div
                ...
                onClick={onClose}
            />
            <div className="bg-[#262A34] w-full max-w-[310px] rounded-2xl relative z-10 -mt-[570px]">
                {
